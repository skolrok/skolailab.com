...
export default function Showroom({ onOpenContact }: { onOpenContact?: () => void }) {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-white font-sans selection:bg-cyan-500/30">
      ...
      {/* 1. Hero Sekcija */}
      <main className="relative flex flex-col items-center justify-center min-h-[80vh] px-6 text-center md:px-12 overflow-hidden">
        <div className="max-w-5xl mx-auto flex flex-col items-center z-10 my-32 transform-gpu will-change-transform">
          <motion.h1 
            initial={{ opacity: 0, y: 40 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.8, ease: [0.16, 1, 0.3, 1] }}
            className="font-display text-6xl sm:text-7xl md:text-8xl lg:text-9xl font-black leading-[1.05] tracking-tight mb-8 text-white drop-shadow-2xl transform-gpu will-change-transform"
          >
            SHOWROOM.
          </motion.h1>
      ...
      <section className="relative px-6 py-24 md:px-12 lg:py-32 w-full max-w-[1400px] mx-auto border-t border-white/5">
        <motion.h2 
      ...
      <section className="relative px-6 py-24 md:px-12 lg:py-40 max-w-[1400px] mx-auto border-t border-white/5">
        <motion.h2 
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-4 md:gap-6 auto-rows-[300px] md:auto-rows-[350px]">
          ...
          >
            ...
            <div className="video-overlay absolute inset-0 bg-black/0 group-hover:bg-black/70 transition-colors duration-400 flex flex-col justify-end p-6 md:p-8">
              <div className="translate-y-8 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-400 ease-out">
                <h3 className="font-display text-2xl md:text-3xl font-bold text-white mb-2 uppercase tracking-wide">{t.showroom.items.b2b.title}</h3>
                <p className="font-mono text-sm md:text-base text-[#00f0ff] uppercase tracking-widest">{t.showroom.items.b2b.desc}</p>
              </div>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="video-overlay absolute inset-0 bg-black/0 group-hover:bg-black/70 transition-colors duration-400 flex flex-col justify-end p-6 md:p-8">
              <div className="translate-y-8 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-400 ease-out">
                <h3 className="font-display text-xl md:text-2xl font-bold text-white mb-2 uppercase tracking-wide">{t.showroom.items.stock.title}</h3>
                <p className="font-mono text-xs md:text-sm text-[#00f0ff] uppercase tracking-widest">{t.showroom.items.stock.desc}</p>
              </div>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="video-overlay absolute inset-0 bg-black/0 group-hover:bg-black/70 transition-colors duration-400 flex flex-col justify-end p-6 md:p-8">
              <div className="translate-y-8 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-400 ease-out">
                <h3 className="font-display text-xl md:text-2xl font-bold text-white mb-2 uppercase tracking-wide">{t.showroom.items.ads.title}</h3>
                <p className="font-mono text-xs md:text-sm text-[#ff00ff] uppercase tracking-widest">{t.showroom.items.ads.desc}</p>
              </div>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="video-overlay absolute inset-0 bg-black/0 group-hover:bg-black/70 transition-colors duration-400 flex flex-col justify-end p-6 md:p-8">
              <div className="translate-y-8 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-400 ease-out">
                <h3 className="font-display text-2xl md:text-3xl font-bold text-white mb-2 uppercase tracking-wide">{t.showroom.items.action.title}</h3>
                <p className="font-mono text-sm md:text-base text-[#00f0ff] uppercase tracking-widest">{t.showroom.items.action.desc}</p>
              </div>
            </div>
          </motion.div>
