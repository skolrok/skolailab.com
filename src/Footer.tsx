      ...
      <div className="max-w-7xl mx-auto flex flex-col items-center">
        ...
        <div className="w-full border-t border-white/10 pt-8 flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-6">
            <a href="https://www.instagram.com/skolailab?igsh=dTZxcWNxZDYzZW11&utm_source=qr" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-[#00f0ff] hover:scale-110 transition-all duration-300">
              <Instagram size={20} />
            </a>
            <a href="https://www.facebook.com/share/18CDHoEXnV/?mibextid=wwXIfr" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-[#ff00ff] hover:scale-110 transition-all duration-300">
